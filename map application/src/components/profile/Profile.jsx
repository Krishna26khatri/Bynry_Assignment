        ...
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {filteredData.map((user, index) => (
                    ...
                    >
                        <div className="flex justify-center h-56  object-cover"> <img src={user.image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdO2DCDcfM7yDAtEo797CkSw_njibgz-lOgw&s"} alt="image"/></div>
                        ...
                        <div className="text-gray-700 truncate"><div className="font-bold inline">Description: </div>{user.description}</div>
